...
object BuildSettings extends Build {
  ...
  lazy val common = Project("common", file("common"), settings = buildSettings
    ++Seq(scalaSource in Compile := file("/Users/vinaygangadhar/IdeaProjects/softbrain-sodor-dev/src/main/scala/common")))
  lazy val rv32_3stage = Project("rv32_3stage", file("rv32_3stage"), settings = buildSettings ++ chipSettings
    ++Seq(scalaSource in Compile := file("/Users/vinaygangadhar/IdeaProjects/softbrain-sodor-dev/src/main/scala/rv32_3stage"))) dependsOn(common) dependsOn(softbrain)
  lazy val softbrain = Project("softbrain", file("softbrain"), settings = buildSettings ++ chipSettings
    ++Seq(scalaSource in Compile := file("/Users/vinaygangadhar/IdeaProjects/softbrain-sodor-dev/src/main/scala/softbrain"))) dependsOn(common)
