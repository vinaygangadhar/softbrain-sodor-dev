...
all_targets := rv32_3stage 
#rv32_2stage rv32_3stage rv32_5stage rv32_ucode
targets     := $(all_targets)
...
jenkins-build:
	make SBT_FLAGS="-Dsbt.log.noformat=true -DchiselVersion=2.3-SNAPSHOT" clean run-emulator
	make reports
